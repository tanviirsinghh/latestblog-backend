...
// .wrangler/tmp/bundle-DysEXR/checked-fetch.js
...
// .wrangler/tmp/bundle-DysEXR/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-DysEXR/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
userRoute.post("/signup", async (c) => {
  ...
  const tokenotp = import_otplib.authenticator.generate(OTPSECRET);
