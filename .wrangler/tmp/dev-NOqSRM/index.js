...
// .wrangler/tmp/bundle-4JBhsC/checked-fetch.js
...
// .wrangler/tmp/bundle-4JBhsC/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-4JBhsC/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
init_checked_fetch();
init_modules_watch_stub();
var sendOtp = /* @__PURE__ */ __name(async ({ email, apikey, otp }) => {
  ...
  const response = await fetch("https://api.brevo.com/v3/smtp/email", {
    ...
    body: JSON.stringify({
      sender: { name: "Blog APP", email: "ustaalokkyanon6107@gmail.com" },
  ...
  if (!response.ok) {
    ...
    console.error("Error from Brevo API:", error);
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    const otpResponse = sendOtp({ apikey, otp, email });
