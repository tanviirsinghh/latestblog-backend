...
// .wrangler/tmp/bundle-DJq0Kp/checked-fetch.js
...
// .wrangler/tmp/bundle-DJq0Kp/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-DJq0Kp/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    try {
      const otp = import_otplib.totp.generate(c.env.SECRET);
