...
// .wrangler/tmp/bundle-YFzcUE/checked-fetch.js
...
// .wrangler/tmp/bundle-YFzcUE/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-YFzcUE/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    console.log(secret);
    try {
      const otp = import_otplib.totp.generate(c.env.OTP_SECRET);
