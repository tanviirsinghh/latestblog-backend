...
// .wrangler/tmp/bundle-YkLoGm/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config2 = {
      "generator": {
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Git-Blog\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@tanviirsinghh/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@tanviirsinghh/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    init_process();
...
var require_plugin_crypto = __commonJS({
  "node_modules/@otplib/plugin-crypto/index.js"(exports) {
    ...
    var createDigest = /* @__PURE__ */ __name((algorithm, hmacKey, counter) => {
      const hmac = crypto2.createHmac(algorithm, Buffer2.from(hmacKey, "hex"));
      const digest = hmac.update(Buffer2.from(counter, "hex")).digest();
...
var require_thirty_two = __commonJS({
  "node_modules/thirty-two/lib/thirty-two/thirty-two.js"(exports) {
    ...
    exports.encode = function(plain) {
      if (!Buffer2.isBuffer(plain)) {
        plain = new Buffer2(plain);
      }
      var i = 0;
      var j = 0;
      var shiftIndex = 0;
      var digit = 0;
      var encoded = new Buffer2(quintetCount(plain) * 8);
    ...
    exports.decode = function(encoded) {
      ...
      var plainChar;
      var plainPos = 0;
      if (!Buffer2.isBuffer(encoded)) {
        encoded = new Buffer2(encoded);
      }
      var decoded = new Buffer2(Math.ceil(encoded.length * 5 / 8));
...
var require_plugin_thirty_two = __commonJS({
  "node_modules/@otplib/plugin-thirty-two/index.js"(exports) {
    ...
    var keyEncoder = /* @__PURE__ */ __name((secret, encoding) => {
      return thirtyTwo.encode(Buffer2.from(secret, encoding).toString("ascii")).toString().replace(/=/g, "");
    }, "keyEncoder");
...
var require_core = __commonJS({
  "node_modules/@otplib/core/index.js"(exports) {
    ...
    var hotpCreateHmacKey = /* @__PURE__ */ __name((algorithm, secret, encoding) => {
      return Buffer2.from(secret, encoding).toString("hex");
    }, "hotpCreateHmacKey");
    ...
    function hotpDigestToToken(hexDigest, digits) {
      const digest = Buffer2.from(hexDigest, "hex");
    ...
    var totpPadSecret = /* @__PURE__ */ __name((secret, encoding, minLength) => {
      ...
      const hexSecret = Buffer2.from(secret, encoding).toString("hex");
      if (currentLength < minLength) {
        const newSecret = new Array(minLength - currentLength + 1).join(hexSecret);
        return Buffer2.from(newSecret, "hex").slice(0, minLength).toString("hex");
      }
      return hexSecret;
    }, "totpPadSecret");
...
// .wrangler/tmp/bundle-YkLoGm/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-YkLoGm/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
var OTPSECRET = "fuckyoubitchgotohell";
userRoute.post("/signup", async (c) => {
  const prisma = new import_edge.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
  import_otplib.totp.options = {
    epoch: Date.now(),
    step: 30,
    window: 0
  };
  console.log("entered backend signup ");
  const otp = import_otplib.totp.generate(OTPSECRET);
...
blogRoute.use("/*", async (c, next) => {
  ...
  const decode3 = await verify2(verified, c.env.JWT_SECRET);
  console.log(decode3);
  if (decode3 && typeof decode3.id === "string") {
    c.set("userId", decode3.id);
    console.log(decode3.id);
    await next();
  } else {
    c.status(403);
    c.json({
